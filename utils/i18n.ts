...
const translations = {
  en: {
    ...
    noOrdersDescription: 'You haven\'t created any delivery orders yet',
  ...
  si: {
    ...
    enter_confirm_password: 'ඔබේ මුරපදය තහවුරු කරන්න',
    login_success: 'පිවිසීම සාර්ථකයි!',
    signup_success: 'ගිණුම සාර්ථකව සාදන ලදී!',
    reset_link_sent: 'මුරපද නැවත සැකසීමේ සබැඳිය ඔබේ විද්‍යුත් තැපෑලට යවන ලදී',
    passwords_dont_match: 'මුරපද ගැලපෙන්නේ නැත',
    invalid_email: 'කරුණාකර වලංගු විද්‍යුත් තැපෑලක් ඇතුළත් කරන්න',
    password_too_short: 'මුරපදය අවම වශයෙන් අක්ෂර 6ක් විය යුතුය',
    login_error: 'පිවිසීම අසාර්ථක විය. කරුණාකර ඔබේ අක්තපත්‍ර පරීක්ෂා කරන්න.',
    signup_error: 'ලියාපදිංචිය අසාර්ථක විය. කරුණාකර නැවත උත්සාහ කරන්න.',
    reset_error: 'නැවත සැකසීමේ සබැඳිය යැවීම අසාර්ථක විය. කරුණාකර නැවත උත්සාහ කරන්න.',
    ...
    noOrdersDescription: 'ඔබ තවම බෙදාහැරීමේ ඇණවුම් කිසිවක් සාදා නැත',
    createOrder: 'ඇණවුමක් සාදන්න',
    deleteOrder: 'ඇණවුම මකන්න',
    deleteOrderConfirm: 'ඔබට ඇණවුම මැකීමට අවශ්‍ය බව විශ්වාසද',
    delete: 'මකන්න',
    pickup: 'ලබා ගැනීම',
    delivery: 'බෙදාහැරීම',
    phone: 'දුරකථනය',
  ...
  ta: {
    ...
    reset_link_sent: 'கடவுச்சொல் மீட்டமைப்பு இணைப்பு உங்கள் மின்னஞ்சலுக்கு அனுப்பப்பட்டது',
    passwords_dont_match: 'கடவுச்சொற்கள் பொருந்தவில்லை',
    invalid_email: 'சரியான மின்னஞ்சலை உள்ளிடவும்',
    password_too_short: 'கடவுச்சொல் குறைந்தது 6 எழுத்துக்களாக இருக்க வேண்டும்',
    login_error: 'உள்நுழைவு தோல்வியடைந்தது. உங்கள் சான்றுகளைச் சரிபார்க்கவும்.',
    signup_error: 'பதிவு தோல்வியடைந்தது. மீண்டும் முயற்சிக்கவும்.',
    reset_error: 'மீட்டமைப்பு இணைப்பை அனுப்ப முடியவில்லை. மீண்டும் முயற்சிக்கவும்.',
    ...
    noOrdersDescription: 'நீங்கள் இன்னும் எந்த விநியோக ஆர்டர்களையும் உருவாக்கவில்லை',
    createOrder: 'ஆர்டரை உருவாக்கவும்',
    deleteOrder: 'ஆர்டரை நீக்கவும்',
    deleteOrderConfirm: 'ஆர்டரை நீக்க விரும்புகிறீர்களா',
    delete: 'நீக்கு',
    pickup: 'எடுத்தல்',
    delivery: 'விநியோகம்',
    phone: 'தொலைபேசி',
